...
const CreateNew = (props) => {
  ...
  const { reset: resetText, ...author } = useField("text");
...
const Anecdote = ({ anecdotes }) => {
  ...
  return (
    <div>
      <h2>{currentAnecdote.content}</h2>
      <p>has {currentAnecdote.votes} votes</p>
      <p>
        for more info see{" "}
        <a href={currentAnecdote.info}>{currentAnecdote.info}</a>
      </p>
    </div>
  );
};
...
const App = () => {
  ...
  const displayNotification = (notification, secondTimeout) => {
